...
//       this.logger.log(
//         `[IA-ASSISTANT] Intención determinada: "${intencionLimpia}"`,
//       );
...
//         dataCruda = await this.reportesService.getComprasRangoData(
//           inicio,
//           fin,
//           'Asistente_IA',
//         );
//       } else if (intencionLimpia.includes('OPERADOR')) {
//         dataCruda = await this.reportesService.getProductividadOperadorData(
//           inicio,
//           fin,
//         );
//       }
...
//         'Sin respuesta en la capa final.'
//       );
//     } catch (error) {
